...
/**
 * Test case for class Tx_Jhe_newsratings_Controller_DataController.
 *
 * @version $Id$
 ...
 */
class Tx_Jhe_newsratings_Controller_DataControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
